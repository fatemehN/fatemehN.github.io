...
def get_personal_data():
    name = ["Fatemeh", "N. Nokabadi"]
    email = "nourifatemeh1@gmail.com"
    twitter = "FNokabadi"
    github = "fatemehN"
    linkedin = "fatemeh-nokabadi"
    bio_text = f"""
                <p>
                    I am a PHD student at <a href="https://www.ulaval.ca/" target="_blank">Université Laval</a> and <a href="https://mila.quebec/en/" target="_blank">Mila</a> working on object trackers and robustness of learning-based trackers.
                    Since May 2023, I have continued my Ph.D. program to develop adversarial attacks against single object trackers supervised by Professor <a href="https://chgagne.github.io/english/" target="_blank">Christian Gagné</a> and Professor <a href="https://vision.gel.ulaval.ca/~jflalonde/" target="_blank">Jean-François Lalonde</a>.
                    Up to Apr. 2023, I did research on single object tracking with deep reinforcement learning algorithms with Professor Robert Bergevin (Advisor).
                    
                </p>
                <p>For any inquiries, feel free to reach out to me via mail!</p>
                <p>
                    <a href="mailto:nourifatemeh1@gmail.com" style="margin-right: 5px"><i class="far fa-envelope-open fa-lg"></i> Mail</a>
                    <a href="https://twitter.com/FNokabadi" target="_blank" style="margin-right: 5px"><i class="fab fa-twitter fa-lg"></i> Twitter</a>
                    <a href="https://scholar.google.com/citations?user=9J9r3ncAAAAJ&hl=en" target="_blank" style="margin-right: 5px"><i class="fa-solid fa-book"></i> Scholar</a>
                    <a href="https://github.com/fatemehN" target="_blank" style="margin-right: 5px"><i class="fab fa-github fa-lg"></i> Github</a>
                    <a href="https://www.linkedin.com/in/fatemeh-nokabadi/" target="_blank" style="margin-right: 5px"><i class="fab fa-linkedin fa-lg"></i> LinkedIn</a>
                </p>
    """
    footer = """
